class AppError(Exception):
    ...
    def __init__(self, message: str = "Error interno de la aplicación", status_code: int | None = None, code: str | None = None) -> None:
...
class ResourceNotFoundError(AppError):
    ...
    def __init__(self, message: str | None = None, resource: str | None = None, identifier: str | int | None = None) -> None:
...
class DuplicateResourceError(AppError):
    ...
    def __init__(self, message: str | None = None, resource: str | None = None, field: str | None = None, value: str | int | None = None) -> None:
        if message is None and resource is not None:
...
class RateLimitExceededError(AppError):
    ...
    def __init__(self, message: str = "Demasiadas peticiones. Intenta de nuevo más tarde.", retry_after: int = 60) -> None:
        super().__init__(message=message)
